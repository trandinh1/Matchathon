...
const chatsByHackathon: { [key: string]: Chat[] } = {
  "LA Hacks": [
    ...
    },
    {
      id: 3,
      name: "Charlie",
      message: "Does anyone want to pair program?",
      avatar: "👩🏽",
      time: "10:00 am",
    },
    {
      id: 4,
      name: "Diana",
      message: "What’s the most innovative project idea here?",
      avatar: "👩🏾",
      time: "9:45 am",
    },
    {
      id: 5,
      name: "Eve",
      message: "How do we improve AI ethics in hackathons?",
      avatar: "👩🏿",
      time: "9:15 am",
    },
    {
      id: 6,
      name: "Frank",
      message: "Who wants to brainstorm over coffee?",
      avatar: "👨🏼",
      time: "9:15 am",
    },
  ],
        ...
        <div className="space-y-3 mt-5">
          {selectedHackathon && chatsByHackathon[selectedHackathon] ? (
            chatsByHackathon[selectedHackathon].map((chat) => (
              <div
                key={chat.id}
                className="flex items-center p-3 border rounded-lg shadow"
              >
            ...
            <p className="text-gray-500 text-center">
              Your tea cup is empty! ☕ Start swiping in Matchground
            </p>
          )}
        </div>
      </div>
